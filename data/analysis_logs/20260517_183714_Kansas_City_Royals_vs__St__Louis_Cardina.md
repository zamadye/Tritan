# Market Analysis — 2026-05-17 18:37 UTC
...
- `search_web({'query': 'Kansas City Royals vs St. Louis Cardinals 2025 game prediction'})` → [Sat, 16 May 2026] Google News
[Sat, 16 May 2026] Cardinals vs Royals Prediction, Odds, Moneyline, S
- `search_web({'query': 'Cardinals Royals injury report May 2026'})` → [Sun, 17 May 2026] Google News
...
- `get_odds({'sport': 'baseball_mlb', 'team': 'Royals'})` → [ODDS] baseball_mlb — 2 events
  St. Louis Cardinals vs Kansas City Royals (2026-05-17)
    [FanDuel
- `search_web({'query': 'Royals Cardinals May 17 2026 pitching matchup starters'})` → [Sun, 17 May 2026] Google News
