# Market Analysis — 2026-05-17 21:14 UTC
...
- `search_web({'query': 'Madison Keys Strasbourg 2025 results'})` → [Sun, 02 Nov 2025] Google News
[Thu, 07 May 2026] WTA Finals Day 3 Preview: Swiatek, Rybakina eye gr
- `search_web({'query': 'Internationaux de Strasbourg 2025 Madison Keys'})` → [Mon, 11 May 2026] Google News
[Sun, 02 Nov 2025] Victoria Mboko handed wildcard for Roland Garros w
- `search_web({'query': 'Madison Keys vs Cristina Bucsa betting odds 2026'})` → [Sun, 17 May 2026] Google News
[Wed, 14 Jan 2026] Madison Keys vs. Cristina Bucsa prediction, odds, 
- `search_web({'query': 'Madison Keys Cristina Bucsa Strasbourg 2026 prediction head to head'})` → [Sun, 17 May 2026] Google News
[Sun, 17 May 2026] H2H, prediction of Marie Bouzkova vs Katerina Sini
- `get_market_context({'keyword': 'Keys'})` → No related markets found for 'Keys'
