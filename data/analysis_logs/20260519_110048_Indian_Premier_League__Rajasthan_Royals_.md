# Market Analysis — 2026-05-19 11:00 UTC
...
### Reasoning
Statistical signal (n=13,967) suggests market overprices YES at 57% (historical resolution 44.7%), but: (1) Gap is only 3%, below 5% threshold; (2) Entry points at 50-60% have historically poor 33% win rate; (3) No concrete match-specific catalyst (injuries, team news) to directly affect outcome; (4) Previous decisions to SKIP same market with similar reasoning. Edge exists but is too small and pattern-unfavorable to bet.
...
- `search_web({'query': 'Rajasthan Royals vs Lucknow Super Giants IPL 2025 team news'})` → [Sun, 29 Mar 2026] Google News
[Tue, 21 Apr 2026] 2026 IPL Schedule, Standings &amp; Next Match Coun
...
- `search_web({'query': 'Rajasthan Royals injury news team update IPL 2026'})` → [Tue, 19 May 2026] Google News
