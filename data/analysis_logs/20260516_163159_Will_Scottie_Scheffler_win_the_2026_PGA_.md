# Market Analysis — 2026-05-16 16:31 UTC
...
## Tool Calls
- `search_web({'query': 'Scottie Scheffler 2026 PGA Championship prediction'})` → [Sat, 16 May 2026] Google News
[Sat, 16 May 2026] 2026 PGA Championship odds, picks: Surprising week
- `search_web({'query': 'Scottie Scheffler injury 2026'})` → [Wed, 04 Feb 2026] Google News
[Tue, 24 Mar 2026] Without offseason injury, is Scottie Scheffler pre
- `search_web({'query': 'Scottie Scheffler 2026 PGA Championship odds'})` → [Wed, 13 May 2026] Google News
[Sat, 16 May 2026] 2026 PGA Championship odds, tee times, purse, how 
