# Market Analysis — 2026-05-17 17:41 UTC
...
- `get_odds({'sport': 'mlb'})` → [ODDS] baseball_mlb — 15 events
  Tampa Bay Rays vs Miami Marlins (2026-05-17)
    [FanDuel] Miami M
- `search_web({'query': 'Chicago Cubs vs Chicago White Sox 2025 game'})` → [Sun, 17 May 2026] Google News
[Fri, 15 May 2026] Chicago Cubs And White Sox Fans Unify In The Most 
- `search_web({'query': 'Cubs vs White Sox prediction May 17 2026'})` → [Sun, 17 May 2026] Google News
[Sun, 17 May 2026] Cubs vs White Sox Prediction, Odds, Moneyline, Spr
- `get_market_context({'keyword': 'Chicago Cubs'})` → No related markets found for 'Chicago Cubs'
- `search_web({'query': 'Cubs White Sox odds today'})` → [Sat, 16 May 2026] Google News
[Sat, 16 May 2026] Cubs vs White Sox Prediction, Picks &amp; Odds for
