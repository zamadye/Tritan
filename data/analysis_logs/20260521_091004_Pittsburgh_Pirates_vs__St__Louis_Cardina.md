# Market Analysis — 2026-05-21 09:10 UTC
...
- **Crowd Bias:** False
- **Catalyst Type:** STATISTICAL PATTERN / MARKET INEFFICIENCY
- **Catalyst Strength:** 0.70

### Reasoning
Stat signal from n=13,967 shows markets at 54% resolve YES only 44.7% of time, providing ~9.3% edge for NO. Pirates missing key players (SP Jared Jones, C Joey Bart). Sports betting WR is strong (73%), though 50-60% entry range historically weak (25% WR). Market overpricing YES despite similar injuries for both teams.
...
- `search_web({'query': 'Pittsburgh Pirates vs St. Louis Cardinals 2025 results'})` → [Wed, 20 May 2026] Google News
[Tue, 26 Aug 2025] Where to watch Pittsburgh Pirates vs St. Louis Car
- `search_web({'query': 'Pittsburgh Pirates recent form MLB 2025'})` → [Tue, 05 May 2026] Google News
[Fri, 02 Jan 2026] 2026 Spring Training - MLB.com
[Thu, 26 Mar 2026] 
...
- `search_web({'query': 'St. Louis Cardinals recent form MLB 2025'})` → [Tue, 05 May 2026] Google News
[Sat, 27 Sep 2025] 2026 Spring Training - MLB.com
[Sat, 13 Dec 2025] 
- `search_web({'query': 'Pittsburgh Pirates St. Louis Cardinals upcoming series 2025'})` → [Tue, 26 Aug 2025] Google News
