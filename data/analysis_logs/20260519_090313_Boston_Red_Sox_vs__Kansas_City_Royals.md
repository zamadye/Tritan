# Market Analysis — 2026-05-19 09:03 UTC
...
### Reasoning
Market overprices YES by 10.3% based on large historical sample (n=13,967): markets at 55% resolve YES only 44.7% of time. Royals also missing two starting pitchers (Ragans, Bubic). Crowd bias evident in systematic overpricing at this probability range.
...
- `search_web({'query': 'Boston Red Sox vs Kansas City Royals July 2025'})` → [Mon, 18 May 2026] Google News
[Mon, 04 Aug 2025] Where to watch Boston Red Sox vs Kansas City Royal
- `search_web({'query': 'Red Sox Royals injury update May 2026'})` → [Tue, 19 May 2026] Google News
[Tue, 19 May 2026] Royals vs. Red Sox: Injury Report, Updates &amp; P
...
- `get_market_context({'keyword': 'Royals'})` → No related markets found for 'Royals'
