...
## Tool Calls
- `search_web({'query': 'Cameron Young 2026 PGA Championship news'})` → [Sat, 16 May 2026] Google News
[Sat, 16 May 2026] 2026 PGA Championship Round 2 takeaways: Cameron Y
- `search_web({'query': 'Cameron Young PGA Championship 2026 Round 2 performance leaderboard'})` → [Sat, 16 May 2026] Google News
[Sat, 16 May 2026] 2026 PGA Championship Round 2 takeaways: Cameron Y
- `search_web({'query': 'Cameron Young PGA Championship 2026 odds winning chances'})` → [Sat, 16 May 2026] Google News
[Wed, 13 May 2026] 2026 PGA Championship odds, picks: Surprising week
