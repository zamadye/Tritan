# Market Analysis — 2026-05-17 15:01 UTC
...
- `get_odds({'sport': 'baseball_mlb', 'team': 'Arizona Diamondbacks'})` → [ODDS] baseball_mlb — 1 events
  Colorado Rockies vs Arizona Diamondbacks (2026-05-17)
    [FanDuel]
- `search_web({'query': 'Arizona Diamondbacks vs Colorado Rockies May 2026 injury report'})` → [Sun, 17 May 2026] Google News
[Sat, 16 May 2026] Diamondbacks wrap road trip, head home for Giants,
- `search_web({'query': 'Arizona Diamondbacks news today 2026'})` → [Sun, 17 May 2026] Google News
...
- `search_web({'query': 'Colorado Rockies vs Arizona Diamondbacks May 17 2026 starting pitcher'})` → [Sun, 17 May 2026] Google News
[Sun, 17 May 2026] Colorado Rockies news: Tomoyuki Sugano notches his
- `search_web({'query': 'Michael Soroka Arizona Diamondbacks starter May 17 2026'})` → [Sun, 17 May 2026] Google News
[Sun, 17 May 2026] Rockies’ Michael Lorenzen strives to end skid in f
