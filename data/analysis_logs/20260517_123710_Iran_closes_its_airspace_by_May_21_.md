# Market Analysis — 2026-05-17 12:37 UTC
...
### Reasoning
Multi-outcome geopolitical longshot at 11% with no specific breaking news or policy announcement from Iran. Search results show betting activity articles ('bets surge', 'odds fall') but zero evidence of actual Iranian government decision to close airspace. Classic retail overpricing of longshot outcomes in geopolitical markets. Market price inflated above statistical base rate (3%) by speculative activity, not fundamentals.
...
- `search_web({'query': '"Iran closes its airspace" May 21'})` → [Fri, 08 May 2026] Google News
[Sun, 03 May 2026] Iran Airspace Closure Bets Surge - StartupHub.ai
[
- `search_web({'query': 'Iran Airspace Closure Bets Surge StartupHub.ai'})` → [Fri, 08 May 2026] Google News
[Wed, 06 May 2026] Iran Airspace Closure Bets Surge - StartupHub.ai
[
